...
const JobCard = (props) => {
  ...
  let jobApplied = applied ? ' applied ' : " "
  let jobSaved = remind_me ? 'saved' : ""
  return (
    <>
        ...
        <ul className={"job-list"}>
          <li className={"job-preview" + jobApplied + jobSaved }>
            <h2 className="job-title">
             <a href={job_source + job_url} target="_blank" rel="noopener noreferrer" >{ job_title ? job_title : null }</a>
            </h2>
            ...
            <h3 className="company">
              {
                company_page ? 
                  <a href={ company_page ? `${job_source + company_page}people` : null } target="_blank" className="company" rel="noopener noreferrer" >
            ...
            <a href={job_source + job_url} target="_blank" rel="noopener noreferrer" >
